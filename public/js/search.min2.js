...
$(function() {
    ...
    const searchInput =  $(".header-search-wrapper .header-search-input,.search-input-sm .search-box-sm");
    var a = searchInput.data("search");
    // var lang = searchInput.data("lang");
        ...
        if (38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode) {
            ...
            if ($("ul.search-list li").remove(), "" != t) {
                var i = "",
                    ...
                    l = "",
                    n = 0;
                // "http://127.0.0.1:8000/api/v1/autocomplete/"+a+"/tr/search/"+t
                $.getJSON("/template-list.json", function(e) {
