                    ...
                    value: function(t) {
                        ...
                        if (t.target && e.length) {
                            ...
                            if (document.getElementById(i) !== null) {
                              var  n = document.getElementById(i).M_Sidenav;
                              n && n.open(e), t.preventDefault()
                            }
                        }
                    }
                ...
                return _inherits(s, Component), _createClass(s, [{
                    ...
                    value: function(t, e, d) {
                        var i = e.find("img"),
                            ...
                            r = e.text().slice(s + 1);
                        e.html("<span onclick=\"window.open('"+d+"', '_self');\">" + o + "<span class='highlight'>" + a + "</span>" + r + "</span>")
                    }
                }, {
                    ...
                    value: function(t, i) {
                        ...
                        for (var a = 0; a < e.length; a++) {
                            var r = e[a],
                                l = h("<li></li>");
                            r.data ? l.append('<img src="' + r.data + '" class="right circle"><span>' + r.key + "</span>") : l.append("<span>" + r.key + "</span>"), h(this.container).append(l), this._highlight(i, l, r.data)
                        }
                    }
                }, {
                    key: "open",
