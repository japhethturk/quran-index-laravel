...
<head>
    ...
    <meta itemprop="image" content="{{ asset('images/logo/materialize-logo.png') }}"/>
                    ...
                    <li>
                        <h1 class="logo-wrapper">
                          <a class="brand-logo darken-1" href="{{config('app.url')}}">
                            <img src="{{ asset('images/materialize-logo.png') }}" alt="materialize logo">
                            <span class="logo-text hide-on-med-and-down">{{ $meta['name'] }}</span>
                          </a>
                        </h1>
                    </li>
                </ul>
                @yield('search-desktop')
                    ...
                    <form id="navbarForm">
                        <div class="input-field search-input-sm">
                            <input class="search-box-sm" type="search" required="" id="search"
                                   placeholder="Ara" data-search="template-list">
...
<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-fixed hide-on-large-only">
    ...
    <a class="sidenav-trigger btn-floating btn-medium waves-effect waves-light hide-on-large-only" href="#" data-target="slide-out">
      <i style="font-size:30px" class="material-icons">menu</i>
    </a>
</aside>
<!-- END: SideNav-->
